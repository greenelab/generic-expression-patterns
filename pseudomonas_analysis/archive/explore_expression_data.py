...
simulated_expression_filename = os.path.join(
    local_dir, "pseudo_experiment", f"selected_simulated_data_{project_id}_11.txt"
)

simulated_expression = pd.read_csv(
    simulated_expression_filename, sep="\t", header=0, index_col=0
)
...
simulated_expression_filename = os.path.join(
    local_dir, "pseudo_experiment", f"selected_simulated_data_{project_id}_5.txt"
)
...
simulated_DE_filename = os.path.join(
    local_dir, "DE_stats", f"DE_stats_simulated_data_{project_id}_5.txt"
)

flat_simulated_DE = pd.read_csv(simulated_DE_filename, sep="\t", header=0, index_col=0)
...
simulated_DE_filename = os.path.join(
    local_dir, "DE_stats", f"DE_stats_simulated_data_{project_id}_11.txt"
)

simulated_DE = pd.read_csv(simulated_DE_filename, sep="\t", header=0, index_col=0)
...
simulated_DE_filename = os.path.join(
    local_dir, "DE_stats", f"DE_stats_simulated_data_{project_id}_1.txt"
)

leveloff_simulated_DE = pd.read_csv(
    simulated_DE_filename, sep="\t", header=0, index_col=0
)
...
simulated_DE_filename = os.path.join(
    local_dir, "DE_stats", f"DE_stats_simulated_data_{project_id}_2.txt"
)
...
leveloff_simulated_expression = pd.read_csv(
    leveloff_simulated_expression_filename, sep="\t", header=0, index_col=0
)
...
simulated_expression_filename = os.path.join(
    local_dir, "pseudo_experiment", f"selected_simulated_data_{project_id}_2.txt"
)
...
simulated_DE_filename = os.path.join(
    local_dir, "DE_stats", f"DE_stats_simulated_data_{project_id}_3.txt"
)
...
flat_simulated_expression_filename = os.path.join(
    local_dir, "pseudo_experiment", f"selected_simulated_data_{project_id}_3.txt"
)

flat_simulated_expression = pd.read_csv(
    flat_simulated_expression_filename, sep="\t", header=0, index_col=0
)
...
normalized_all_data = pd.concat([normalized_template_data, normalized_compendium_data])
